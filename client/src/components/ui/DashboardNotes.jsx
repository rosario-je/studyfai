...
const DashboardNotes = () => {
    return (
        <div className='bg-zinc-100 hover:bg-zinc-200 hover:border-[1px] border-zinc-400 transition-colors w-[250px] h-[150px] flex-shrink-0 rounded-3xl p-6 items-center'>
